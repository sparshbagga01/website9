...
<form id="checkoutForm" action="process" method="post" target="hidden_iframe">
  ...
  <div class="row gy-4">
   ...
   <input type="hidden" name="product_unit" id="productUnitInput" value="pieces">
...
<input type="hidden" name="product_total_price" id="productTotalPriceInput" value="<?php echo $product_price; ?>">
  ...
  <div class="col-md-6 mb-3">
    ...
    <select class="form-select" id="unit" name="unit" onchange="updateTotal()">
...
.text-center.mt-4 p {
 ...
 <script>
  ...
  function updateTotal() {
    ...
    document.getElementById("grandTotal").textContent = "₹" + total.toLocaleString("en-IN") + " (Including GST)";
