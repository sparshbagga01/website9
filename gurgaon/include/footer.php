    ...
    <footer id="contact">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h3>Hot Products</h3>
                    <a href="<?php echo $baseurl ?>gurgaon/pouch-packaging-machine.php">Pouch Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>gurgaon/powder-packaging-machine.php">Powder Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>gurgaon/liquor-pouch-packaging-machine.php">Liquor Pouch Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>gurgaon/shampoo-pouch-packing-machine.php">Shampoo Pouch Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>gurgaon/ors-powder-pouch-packaging-machine">ORS Powder Pouch Packaging Machine</a>
                ...
                <div class="footer-section">
                    ...
                    <p> Plot No. 8, Gali No. 8E,Sarurpur Industrial Area,Sohna Road, gurgaon ,Haryana 121004</p>
