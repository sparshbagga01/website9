                ...
                <div class="related-products-grid">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/pouch-packaging-machine" class="btn-view-details">View Details</a>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/multitrack-pouch-packaging-machine.php" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/tomato-ketchup-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/ketchup-multitrack-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/sauce-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/pickles-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/shampoo-pouch-packing-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/hair-oil-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/mayonnaise-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/ginger-garlic-paste-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/tomato-paste-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/ghee-pouch-packing-machine " class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/liquor-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/powder-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/garam-masala-pouch-packing-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/granules-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/gutkha-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/ors-powder-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/detergent-powder-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/rasna-powder-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/servo-auger-powder-filling-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/tea-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>bhubaneswar/coffee-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
