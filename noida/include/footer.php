    ...
    <footer id="contact">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h3>Hot Products</h3>
                    <a href="<?php echo $baseurl ?>noida/pouch-packaging-machine.php">Pouch Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>noida/powder-packaging-machine.php">Powder Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>noida/liquor-pouch-packaging-machine.php">Liquor Pouch Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>noida/shampoo-pouch-packing-machine.php">Shampoo Pouch Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>noida/ors-powder-pouch-packaging-machine">ORS Powder Pouch Packaging Machine</a>
                ...
                <div class="footer-section">
                    ...
                    <p> Plot No. 8, Gali No. 8E,Sarurpur Industrial Area,Sohna Road, noida ,Haryana 121004</p>
