    ...
    <footer id="contact">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h3>Hot Products</h3>
                    <a href="<?php echo $baseurl ?>bhubaneswar/pouch-packaging-machine.php">Pouch Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>bhubaneswar/powder-packaging-machine.php">Powder Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>bhubaneswar/liquor-pouch-packaging-machine.php">Liquor Pouch Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>bhubaneswar/shampoo-pouch-packing-machine.php">Shampoo Pouch Packaging Machine</a>
                    <a href="<?php echo $baseurl ?>bhubaneswar/ors-powder-pouch-packaging-machine">ORS Powder Pouch Packaging Machine</a>
                ...
                <div class="footer-section">
                    ...
                    <p> Plot No. 8, Gali No. 8E,Sarurpur Industrial Area,Sohna Road, bhubaneswar ,Haryana 121004</p>
    ...
    <script>
        ...
        document.querySelectorAll('.whatsapp-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                window.open(`https://wa.me/+91-9953043939?text=${encodeURIComponent(message)}`, '_blank');
            });
        });
        ...
        document.querySelectorAll('.quote-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                const productName = this.closest('.product-card').querySelector('h3').textContent;
                alert(`For current pricing of ${productName}, please contact us at +91-9953043939 or send us a WhatsApp message.`);
            });
        });

        // WhatsApp Float Button
        document.querySelector('.whatsapp-float').addEventListener('click', function() {
            const message = `Hi, I'm interested in your Packaging Machinery. Please provide more information.`;
            window.open(`https://wa.me/+91-9953043939?text=${encodeURIComponent(message)}`, '_blank');
        });
