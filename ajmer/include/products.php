                ...
                <div class="related-products-grid">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/pouch-packaging-machine" class="btn-view-details">View Details</a>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/multitrack-pouch-packaging-machine.php" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/tomato-ketchup-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/ketchup-multitrack-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/sauce-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/pharmaceutical-blister-foil-printing-machines.php" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/shampoo-pouch-packing-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/hair-oil-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/mayonnaise-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/ginger-garlic-paste-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/tomato-paste-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/ghee-pouch-packing-machine " class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/liquor-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/powder-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/garam-masala-pouch-packing-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/granules-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/gutkha-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                     <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/ors-powder-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/detergent-powder-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/rasna-powder-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/servo-auger-powder-filling-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/tea-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
                    <div class="related-product-card">
                        ...
                        <div class="related-product-info">
                            ...
                            <div class="related-product-buttons">
                                <a href="<?php echo $baseurl ?>ajmer/coffee-pouch-packaging-machine" class="btn-view-details">View Details</a>
                                <button class="btn-quick-quote" onclick="openForm()">Quick Quote</button>
                            </div>
                        </div>
                    </div>
